...
export default function IconsSelectioncheckedempty(props) {
      ...
      paths={[
        {
          ...
          style: {
            transform:
              "translate(calc(50% - 9px - 0px), calc(50% - 9px - 0px))",
          },
        },
      ]}
      {...rest}
      {...getOverrideProps(overrides, "IconsSelectioncheckedempty")}
    ></Icon>
  );
}
