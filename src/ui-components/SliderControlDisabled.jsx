...
export default function SliderControlDisabled(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "SliderControlDisabled")}
    >
      <View
        position="absolute"
        top="42.86%"
        ...
        {...getOverrideProps(overrides, "Rectangle414474")}
      ></View>
      <View
        position="absolute"
        top="42.86%"
        ...
        padding="0px 0px 0px 0px"
        backgroundColor="rgba(196,196,196,1)"
        {...getOverrideProps(overrides, "Rectangle414475")}
      ></View>
      <Icon
        width="13px"
        height="13px"
