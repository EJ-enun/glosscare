...
export default function VisibilityOff(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "VisibilityOff")}
    >
      <View
        padding="0px 0px 0px 0px"
        position="absolute"
